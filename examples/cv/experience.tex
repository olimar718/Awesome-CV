...
\begin{cventries}
	...
	{Octobre 2025 - Présent} % Dates
	{
		...
		\item Développement backend (Python/FastAPI, Java/Spring) d'applications web de configuration réseau :
			\begin{itemize}
				\item Conception de nouvelles fonctionnalités (endpoints REST) et refactorisation du code existant
				...
				\item Support technique aux équipes d'intégration sur les bancs d'essai
				\item Collaboration directe avec les ingénieurs système pour affiner les spécifications
				\item Synchronisation avec les équipes de développement front-end
			\end{itemize}
		\end{cvitems}
	}
