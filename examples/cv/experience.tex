...
\begin{cventries}
	...
	{Février 2024 - Présent} % Dates
	{
		...
		\item{
			Projet : Développement de plusieurs logiciels embarqués en \textbf{C++} et \textbf{Java (Swing)}, utilisant \textbf{IBM Rational Rhapsody} (Statecharts, \textbf{UML}) pour la génération de code
			\begin{itemize}
		...
		\item{
			...
			\begin{itemize}
				\item{\textbf{C++}, \textbf{Java} (\textbf{Swing} : interface graphique) : Conception et développement de nouvelles fonctionnalités, refonte de fonctionnalités existantes issues de code \emph{legacy}, correction de bugs existants}
				...
				\item{\textbf{Intégration} de code source \textbf{C++} fournis par une autre équipe : validation de l'impact du changement d'environnement de compilation et d'exécution, diagnostic et remontée des dysfonctionnements éventuels pour correction}
			\end{itemize}
		}
		\item{
			...
			\begin{itemize}
				...
				\item{Automatisation de tests d'une interface graphique \textbf{Java Swing}. Utilisation de \emph{Robot} pour cliquer sur boutons, utilisation de \emph{java.lang.reflect} pour obtenir la valeur des champs}
